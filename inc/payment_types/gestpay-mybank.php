...
class WC_Gateway_Gestpay_MYBANK extends WC_Gateway_Gestpay {
    ...
    function payment_fields() {
        ...
        $mybank_url = '<a href="https://www.mybankpayments.eu/" target="_blank" title="MyBank"><strong>www.mybankpayments.ue</strong></a>';
        $mybank_banner = '<div id="mybank-container-img"><a href="https://www.mybankpayments.eu/" target="_blank"><img src="https://www.mybankpayments.eu/img/brand/en/tagline_positive.png" style="background-color:#fff!important"/></a></div>';
    ...
    public function show_banks_as_select( $banks ) {
        ...
        echo '<p><a href="https://www.mybankpayments.eu/#faq" target="_blank">' . $this->strings['gestpay_mybank_list_notfound'] . '</a></p>';
    }
    ...
    public function show_mybank_logo_after_payment( $order ) {
        ...
        echo '<a href="https://www.mybankpayments.eu/" target="_blank"><img src="https://www.mybankpayments.eu/img/brand/en/tagline_positive.png" /></a>';
    }
